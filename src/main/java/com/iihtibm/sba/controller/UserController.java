...
import com.iihtibm.sba.model.AuthToken;
...
import com.iihtibm.sba.service.UserService;
...
public class UserController {
	...
	@PostMapping("/signin")
	public com.iihtibm.sba.model.ApiResponse<?> signin(
		...
		return new com.iihtibm.sba.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.user.signin"),
				new AuthToken(user.getId(), user.getFirstName(), authentication.getAuthorities().toString(), token));

	}

	
	@ApiOperation(value = "Signup user details and send mail to active account", response = com.iihtibm.sba.model.ApiResponse.class)
	@ApiResponses(value = {
		@ApiResponse(code = 200, message = "Successfully performed the operation"),
	...
	@PostMapping("/signup")
	public com.iihtibm.sba.model.ApiResponse<?> signup(
			@ApiParam(value = "User details which needs to signup", required = true) @Valid @RequestBody User user,
			HttpServletRequest request) {

		return new com.iihtibm.sba.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.user.signup"), userService.signup(user, request));

	}

	@ApiOperation(value = "Validate user and send mail to reset password", response = com.iihtibm.sba.model.ApiResponse.class)
	@ApiResponses(value = {
		@ApiResponse(code = 200, message = "Successfully performed the operation"),
		@ApiResponse(code = 404, message = "Resource Not Found"),
		@ApiResponse(code = 503, message = "Service Unavailable")
	...
	public com.iihtibm.sba.model.ApiResponse<?> forgetPassword(
		...
		return new com.iihtibm.sba.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.user.resetpwd"));
	}
	
	@ApiOperation(value = "Block/Unblock am user", response = com.iihtibm.sba.model.ApiResponse.class)
	@ApiResponses(value = {
		@ApiResponse(code = 200, message = "Successfully performed the operation"),
		@ApiResponse(code = 404, message = "Resource Not Found"),
		@ApiResponse(code = 503, message = "Service Unavailable")
	...
	public com.iihtibm.sba.model.ApiResponse<?> blockUnblockUser(
		...
		return new com.iihtibm.sba.model.ApiResponse<>(HttpStatus.OK.value(),
				Translator.toLocale("success.user.block-unblock", (block.booleanValue() == false ? "blocked" : "unblocked")),
				userService.updateProfile(user));

	}

	@ApiOperation(value = "Update user details", response = com.iihtibm.sba.model.ApiResponse.class)
	@ApiResponses(value = {
		@ApiResponse(code = 200, message = "Successfully performed the operation"),
		@ApiResponse(code = 404, message = "Resource Not Found"),
		@ApiResponse(code = 503, message = "Service Unavailable")
	...
	public com.iihtibm.sba.model.ApiResponse<?> updateProfile(
			@ApiParam(value = "User details which needs to update", required = true) @Valid @RequestBody User user) {

		return new com.iihtibm.sba.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.user.update"),
				userService.updateProfile(user));

	}

	@ApiOperation(value = "Delete user details", response = com.iihtibm.sba.model.ApiResponse.class)
	@ApiResponses(value = {
		@ApiResponse(code = 200, message = "Successfully performed the operation"),
		@ApiResponse(code = 404, message = "Resource Not Found"),
		@ApiResponse(code = 503, message = "Service Unavailable")
	...
	public com.iihtibm.sba.model.ApiResponse<?> deleteProfile(
			@ApiParam(value = "User Id for which record needs to delete", required = true) @PathVariable(value = "id", required = true) Long id) {

		userService.deleteProfile(id);
		return new com.iihtibm.sba.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.user.delete"));
	}
